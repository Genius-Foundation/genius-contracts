...
/**
 * @title DeployBSCGeniusEcosystem
 * @dev A contract for deploying the GeniusExecutor contract.
        Deployment commands:
        `source .env` // Load environment variables
        BSC: forge script script/deployment/DeployBSCGeniusEcosystem.s.sol:DeployBSCGeniusEcosystem --rpc-url $BSC_RPC_URL --broadcast -vvvv --via-ir
 */
contract DeployBSCGeniusEcosystem is Script {
    address public constant stableAddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public constant bridgeAddress = 0x4a364f8c717cAAD9A442737Eb7b8A55cc6cf18D8;
