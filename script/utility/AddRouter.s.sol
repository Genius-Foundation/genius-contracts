...
contract AddRouter is Script {
    function run() external {
        ...
        GeniusGasTank geniusGasTank = GeniusGasTank(
            payable(0x7365CE0CbdBfB9D510FB06cE8155a3229F46811F)
        );

        bool _hasRole = geniusGasTank.hasRole(DEFAULT_ADMIN_ROLE, msg.sender);
        ...
        console.log(
            "Router '0xf332761c673b59B21fF6dfa8adA44d78c12dEF09' added to GeniusGasTank"
        );
    }
}
