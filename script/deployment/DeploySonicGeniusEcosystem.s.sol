...
// COMMAND: forge script script/deployment/DeploySonicGeniusEcosystem.s.sol --rpc-url $SONIC_RPC_URL --broadcast --via-ir
contract DeploySonicGeniusEcosystem is DeployGeniusEcosystemCore {
