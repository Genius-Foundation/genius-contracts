...
/**
 * @title DeployBlastGeniusEcosystem
 * @dev A contract for deploying the GeniusExecutor contract.
        Deployment commands:
        `source .env` // Load environment variables
        BLAST: forge script script/deployment/DeployBlastGeniusEcosystem.s.sol:DeployBlastGeniusEcosystem --rpc-url $BLAST_RPC_URL --broadcast -vvvv --via-ir
 */
