...
contract DeployBSCGeniusEcosystem is DeployGeniusEcosystemCore {
    ...
    function run() external {
        ...
        minFees[0] = 100_000_000_000_000_000; // $0.1 BSC (18 decimals)
        minFees[1] = 100_000_000_000_000_000; // $0.1 BASE
        minFees[2] = 100_000_000_000_000_000; // $0.1 ARBITRUM
        minFees[3] = 100_000_000_000_000_000; // $0.1 OPTIMISM
        minFees[4] = 100_000_000_000_000_000; // $0.1 AVALANCHE
        minFees[5] = 100_000_000_000_000_000; // $0.1 SOLANA
        minFees[6] = 100_000_000_000_000_000; // $0.1 POLYGON
        minFees[7] = 100_000_000_000_000_000; // $0.1 SONIC
        minFees[8] = 1_000_000_000_000_000_000; // $1 ETHEREUM
        ...
        uint256 insuranceFee = 3; // 0.03% for insurance fee
        uint256 maxOrderSize = 10_000_000_000_000_000_000; // 10,000usd
        _run(
            permit2Address,
            stableAddress,
            priceFeed,
